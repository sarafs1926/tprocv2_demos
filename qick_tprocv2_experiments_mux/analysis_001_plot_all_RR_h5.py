...
class PlotAllRR:
    ...
    def run(self):
        ...
        self.load_plot_save_res_spec(exp_config)
        self.load_plot_save_q_spec(exp_config)
        self.load_plot_save_rabi(exp_config)
        self.load_plot_save_ss(exp_config)
        self.load_plot_save_t1(exp_config)
        self.load_plot_save_t2r(exp_config)
        self.load_plot_save_t2e(exp_config)
