...
h5_filename = '/data/QICK_data/6transmon_run4a/2024-11-12/SingleShot_Test/qubit_4_data_20241112_114218.h5'  # Update with your file path
...
plt.text(max_length + 0.1, max_fidelity, f'max length {max_length:.2f}', color='red')
