# performs avoided crossing experiment between two qubits.
...
qubit_freqs =  np.array([freqs_q1,freqs_q2]) * 1000 # MHz
qubit_start = qubit_freqs - np.array([[20] * len(qubit_freqs[0]), [20] * len(qubit_freqs[1])])
qubit_stop = qubit_freqs +  np.array([[20] * len(qubit_freqs[0]), [20] * len(qubit_freqs[1])])
...
data_path = "M:/malab/_Data/20250130 - Santi - RFSoC tprocv2 - LL8qubit J meas Q1 Q2/data/third_iteration"
