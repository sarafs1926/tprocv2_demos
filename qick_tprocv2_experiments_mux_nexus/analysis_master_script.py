...
signal = 'None'
number_of_qubits = 4
run_number = 30 #run 30 at nexus, change for each run
figure_quality = 100 #ramp this up to like 500 for presentation plots
final_figure_quality = 200
run_name = 'Run30' #update in each new run
...
# ############# 05: Qubit Temp vs time (NOT working currently, use arianna code at bottom, section 15) #############################
